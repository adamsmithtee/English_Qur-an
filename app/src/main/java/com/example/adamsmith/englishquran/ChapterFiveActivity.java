...
public class ChapterFiveActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private String mChapters = QueryUtils001.CHAPTER_FIVE_JSON;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tittleTextView.setText(R.string.qur_5);


        number_verse_text = (TextView) findViewById(R.id.number_verse_text);
        number_verse_text.setText(R.string.ver_5);
...
//                            ChapterFiveActivity.super.onBackPressed();
                            finish();
                        }
                    }).create().show();
//            super.onBackPressed();
...
//            chapterTwo();
    ...
    public void chapterOne() {
        Context context = ChapterFiveActivity.this;
...
//    }
    ...
    public void chapterSix() {
        Intent intent = new Intent(ChapterFiveActivity.this, ChapterSixActivity.class);
    ...
    protected String[] loadJsonData(){
        try {
            String[] jsonData = ChaptersFunction.getVersesStringsFromJson(ChapterFiveActivity.this, mChapters );
            return jsonData;
        }catch (Exception e){
