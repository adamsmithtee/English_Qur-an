...
public class ChapterSixActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private String mChapters = QueryUtils001.CHAPTER_SIX_JSON;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tittleTextView.setText(R.string.qur_6);


        number_verse_text = (TextView) findViewById(R.id.number_verse_text);
        number_verse_text.setText(R.string.ver_6);
...
//                            ChapterSixActivity.super.onBackPressed();
                            finish();
                        }
                    }).create().show();
//            super.onBackPressed();
...
//            chapterTwo();
    ...
    public void chapterOne() {
        Context context = ChapterSixActivity.this;
...
//    }
    ...
    public void chapterFive() {
        Intent intent = new Intent(ChapterSixActivity.this, MainActivity.class);
    ...
    protected String[] loadJsonData(){
        try {
            String[] jsonData = ChaptersFunction.getVersesStringsFromJson(ChapterSixActivity.this, mChapters );
            return jsonData;
        }catch (Exception e){
