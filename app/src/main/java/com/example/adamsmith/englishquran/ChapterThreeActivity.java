...
public class ChapterThreeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private String mChapters = QueryUtils001.CHAPTER_THREE_JSON;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tittleTextView.setText(R.string.qur_3);

        number_verse_text = (TextView) findViewById(R.id.number_verse_text);
        number_verse_text.setText(R.string.ver_3);
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface arg0, int arg1) {
                            ChapterThreeActivity.super.onBackPressed();
                        }
                    }).create().show();
//            super.onBackPressed();
        }
...
//    }
    ...
    public void chapterSix() {
        Intent intent = new Intent(ChapterThreeActivity.this, ChapterSixActivity.class);
    ...
    //methods that loads json data
    protected String[] loadJsonData(){
        try {
            String[] jsonData = ChaptersFunction.getVersesStringsFromJson(ChapterThreeActivity.this, mChapters );
            return jsonData;
        }catch (Exception e){
